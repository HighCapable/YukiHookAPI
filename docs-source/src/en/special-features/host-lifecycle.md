...
For more functions, please refer to [AppLifecycle](kdoc://yukihookapi-core/yukihookapi-core/com.highcapable.yukihookapi.hook.param/-package-param/-app-lifecycle).
