...
### 1.3.2 | 2026.05.30 &ensp;<Badge type="latest" text="latest" vertical="middle" />
...
- This is a major version update, please refer to [KDoc](kdoc://yukihookapi-core) and [Special Features](../special-features/reflection) for the changes and usage mentioned in the changelog
