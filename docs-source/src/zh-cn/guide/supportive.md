...
| 名称                                                                                   | 可用性 | 描述                                                                                                          |
| -------------------------------------------------------------------------------------- | :----: | ------------------------------------------------------------------------------------------------------------- |
| ~~[字节码与反射扩展](../special-features/reflection)~~                             | ❗   | 已全面弃用，推荐迁移至 [KavaRef](https://github.com/HighCapable/KavaRef)，计划 YukiHookAPI `2.0.0` 版本移除 |
| [Xposed 模块数据存储](../special-features/xposed-storage)                          | ✅   | 正常使用                                                                                                      |
| [Xposed 模块与宿主通讯桥](../special-features/xposed-channel)                      | ✅   | 正常使用                                                                                                      |
| [宿主生命周期扩展](../special-features/host-lifecycle)                             | ✅   | 正常使用                                                                                                      |
| [注入模块资源 (Resources)](../special-features/host-inject#注入模块资源-resources) | ✅   | 正常使用                                                                                                      |
| [注册模块 Activity](../special-features/host-inject#注册模块-activity)             | ✅   | 正常使用                                                                                                      |
