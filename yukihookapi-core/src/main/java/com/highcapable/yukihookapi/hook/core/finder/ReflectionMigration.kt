...
/**
 * Migration guide for the YukiHookAPI reflection API.
 */
internal object ReflectionMigration {

    /**
     * [KavaRef](https://github.com/HighCapable/KavaRef) migration guide.
     */
    const val KAVAREF_INFO = "YukiHookAPI will completely remove the API of its own reflection part in version 2.0.0. " +
